<head>
    ...
    <link type="images/x-icon" rel="shortcut icon" href="/custom/assets/favicon.ico">
                ...
                <div class="login-container">
                    <div class="center">
                        <h1>
                            ...
                            <span class="white" id="id-text2">allonsy</span>
                        </h1>
                        <h4 class="blue" id="id-company-text">&copy; allonsy</h4>
                    </div>
                        ...
                        <div id="login-box" class="login-box visible widget-box no-border">
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <form id="_loginForm" action="${_path}/login.json" method="post"
...
<script type="text/javascript" src="/custom/jquery.cookie.js"></script>
<script type="text/javascript" src="/custom/jquery.form.min.js"></script>
<script type="text/javascript" src="/custom/jquery.validate-2.0.min.js"></script>
<script type="text/javascript" src="/custom/jquery.validate-2.0.custom.min.js"></script>
